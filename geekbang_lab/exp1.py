...
OUT = r"C:/Users/admin/Desktop/scrapy-practice/geekbang_lab/exp1_raw.json"
...
def main():
    ...
    for pt in [0, 1, 2]:
        ...
        print(f"[done] product_type={pt} status={status} products={n} saved {len(results)}/3", flush=True)
        if pt != 2:
